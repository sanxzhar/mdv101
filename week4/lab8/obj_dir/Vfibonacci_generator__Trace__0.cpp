...
void Vfibonacci_generator___024root__trace_chg_0_sub_0(Vfibonacci_generator___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+3,(vlSelfRef.fib_out),32);
    bufp->chgIData(oldp+4,(vlSelfRef.fibonacci_generator__DOT__fib_prev1),32);
    bufp->chgIData(oldp+5,(vlSelfRef.fibonacci_generator__DOT__fib_prev2),32);
}
