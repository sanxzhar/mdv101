...
VL_ATTR_COLD void Vand_gate___024root__trace_init_sub__TOP__0(Vand_gate___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+2,0,"in0",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void Vand_gate___024root__trace_full_0_sub_0(Vand_gate___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelfRef.in1));
    bufp->fullBit(oldp+2,(vlSelfRef.in0));
    bufp->fullBit(oldp+3,(vlSelfRef.out));
}
