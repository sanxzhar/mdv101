...
def print_all_modules():
    ...
    print("For example:")
    print("   python3 lock_run.py -s [module name]")
...
def compile_all(should_gen_wave):
    ...
    for module in MODULES:
        ...
        os.system(RUN_COMMAND.format(module))
...
def parse_arguments():
    ...
    parser.add_argument('-s', '--compile-single', type=str, metavar="MODULE", help=HELP_MSG_COMPILE_SINGLE)
